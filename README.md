...
- Проверяю ДЗ пару раз в неделю. Частота зависит от загрузки на основной работе. Проекты от недели до двух когда есть достаточный кусок свободного времени. Обычно это выходные.
